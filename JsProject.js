...
const todoInput = document.querySelector(".todo-input"); //This return whatever given in the input for the Todo
...
function addTodo(event) {
    ...
    completedButton.innerHTML = '<i class ="fas fa-check"></i>';//This renders the fontawesome icons
    completedButton.classList.add("complete-btn");
    todoDiv.appendChild(completedButton);

    //Adding the check trash button
    const trashButton = document.createElement("button");
    trashButton.innerHTML = '<i class ="fas fa-trash"></i>';//This renders the fontawesome icons
